...
@if($turno_id)
    <div class="alert alert-info small py-2">
        Orden creada a partir del turno del 
        <strong>{{ \Carbon\Carbon::parse(App\Models\TurnoServicio::find($turno_id)->fecha)->format('d/m/Y') }}</strong>
        a las 
        <strong>{{ \Carbon\Carbon::parse(App\Models\TurnoServicio::find($turno_id)->hora_inicio)->format('H:i') }}</strong>.
        @if($nota_turno)
            <div class="mt-1">Nota: {{ $nota_turno }}</div>
        @endif
    </div>
@endif                
            </div>
    ...
    <div class="row g-2 mb-2">
        <div class="col-md-6">
            ...
            <div class="input-group input-group-sm">
                <select wire:model="cliente_id" id="selectCliente" class="form-select rounded-0">
                ...
                <div class="row g-2 mt-2">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" wire:model="identificador" class="form-control form-control-sm">
                    </div>
                </div>
